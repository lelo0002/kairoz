...
UI_Elements.Local_Group = Tabs.Visuals:AddRightGroupbox("Local")
...
UI_Elements.LC_Dep:AddDropdown("LC_FFAnim", {Values = {"None", "Breathe", "Spectral", "Ethereal", "Vivid", "Glint", "Lustre"}, Default = 1, Text = "Forcefield Animation", Callback = function(v) L.LC_FFAnim = v end})
...
UI_Elements.MBF_Toggle = UI_Elements.Misc_Troll:AddToggle("MBF_Enabled", {Text = "Money Bag Fling", Default = false, Callback = function(v) 
    L.MBF_Enabled = v 
